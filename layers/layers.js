...
jsonSource_jalan_1.addFeatures(features_jalan_1);var lyr_jalan_1 = new ol.layer.Vector({
                ...
                style: style_jalan_1,
    title: 'jalan<br />\
    <img src="styles/legend/jalan_1_0.png" /> jalan desa<br />\
    <img src="styles/legend/jalan_1_1.png" /> jalan desaLL<br />\
    <img src="styles/legend/jalan_1_2.png" /> jalan kampung<br />\
    <img src="styles/legend/jalan_1_3.png" /> jalan komplek<br />\
    <img src="styles/legend/jalan_1_4.png" /> jalan tanah<br />\
    <img src="styles/legend/jalan_1_5.png" /> Jalan utama<br />\
    <img src="styles/legend/jalan_1_6.png" /> <br />'
...
jsonSource_rumah_3.addFeatures(features_rumah_3);var lyr_rumah_3 = new ol.layer.Vector({
                ...
                style: style_rumah_3,
    title: 'rumah<br />\
    <img src="styles/legend/rumah_3_0.png" /> kantor desa<br />\
    <img src="styles/legend/rumah_3_1.png" /> masjid<br />\
    <img src="styles/legend/rumah_3_2.png" /> Mushola<br />\
    <img src="styles/legend/rumah_3_3.png" /> rumah warga<br />\
    <img src="styles/legend/rumah_3_4.png" /> rumah wargaL<br />\
    <img src="styles/legend/rumah_3_5.png" /> <br />'
        });
...
lyr_jalan_1.set('fieldAliases', {'id': 'id', 'nama jalan': 'nama jalan', });
...
lyr_jalan_1.set('fieldImages', {'id': 'TextEdit', 'nama jalan': 'TextEdit', });
...
lyr_jalan_1.set('fieldLabels', {'id': 'no label', 'nama jalan': 'inline label', });
lyr_sungai_2.set('fieldLabels', {'id': 'no label', 'sungai': 'inline label', });
